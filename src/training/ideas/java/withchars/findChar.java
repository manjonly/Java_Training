...
public class findChar {
   /* public int findCharReturnIndexChar(char[] userInputCharArray, char userFindChar) {
    ...
    public int findCharReturnIndexChar(char[] userInputCharArray, char[] userFindCharArray, int atIndex) {
        findCharIndexAtOccurance findCharIndexMethod=new findCharIndexAtOccurance();
        int myCharIndex=findCharIndexMethod.myIndexOF(userInputCharArray,userFindCharArray,atIndex);
        return myCharIndex;
    }
